...
그래서 이 곡은 장례식이 끝난 순간에 진짜 시작된다. 장례식에서 연주될 때는 그저 아름다운 위로일 뿐이다. 하지만 며칠 몇 달이 지난 어느 날 밤, 무심코 올려다본 하늘에서 별을 발견한 누군가가 서늘한 바람 속에서 이 노래를 기억해낼 때, 그때 비로소 음악은 슬픔을 딛고 살아갈 힘을 주는 그 사람만의 이정표로 완성될 것이다.
